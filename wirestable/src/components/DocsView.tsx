  ...
  return (
    <div className="app-container" style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 mt-6">
        <Breadcrumbs items={[{ label: "Docs", url: "/docs" }]} />
      </div>

      {/* Docs Layout */}
      <main className="app-main grid grid-cols-1 md:grid-cols-[240px_1fr] gap-6 w-full max-w-[1200px] mx-auto px-4 pb-12" style={{ flex: 1 }}>
        ...
        <section style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
          ...
          <DiscoveryEngine category="developer" currentPath="/docs" />
        </section>
      </main>
      <Footer />
    </div>
