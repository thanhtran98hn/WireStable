...
export function ContactView() {
  ...
  return (
    <div className="app-container" style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      {/* Grid Layout */}
      <main className="app-main w-full max-w-[960px] mx-auto px-4 py-6" style={{ flex: 1, display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <DiscoveryEngine category="support" currentPath="/contact" />
      </main>
      <Footer />
    </div>
  );
