...
export function FAQView() {
  ...
  return (
    <div className="app-container" style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      {/* FAQ Main */}
      <main className="app-main w-full max-w-[800px] mx-auto px-4 py-6" style={{ display: "flex", flexDirection: "column", gap: "var(--space-5)", flex: 1 }}>
        ...
        <DiscoveryEngine category="general" currentPath="/faq" />
      </main>
      <Footer />
    </div>
  );
