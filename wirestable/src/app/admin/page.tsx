          ...
          <div className="card" style={{ padding: "var(--space-5)" }}>
            ...
            {parsedPreview.length > 0 && (
              <div style={{ marginBottom: "var(--space-4)" }}>
                ...
                <div style={{ maxHeight: "150px", overflowY: "auto", border: "1px solid var(--color-border)", borderRadius: "var(--radius-sm)", marginTop: "6px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
                {batches.map((batch) => (
                  ...
                  >
                    ...
                    <div style={{ background: "var(--color-bg-secondary)", borderRadius: "var(--radius-sm)", padding: "var(--space-3)", maxHeight: "160px", overflowY: "auto", marginBottom: "var(--space-3)" }}>
