...
export default function LandingPage() {
  ...
  return (
    <div className="app-container" style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, maxWidth: "1200px", margin: "0 auto", width: "100%", padding: "0 24px" }}>
        ...
        <section style={{ textAlign: "center", padding: "80px 0 60px 0", display: "flex", flexDirection: "column", alignItems: "center", gap: "24px" }}>
          <span style={{ fontSize: "0.75rem", textTransform: "uppercase", background: "rgba(255,107,74,0.1)", color: "var(--color-primary)", padding: "4px 12px", borderRadius: "100px", fontWeight: 700, letterSpacing: "0.05em" }}>
            Enterprise Stablecoin Remittance Infrastructure
          </span>
        ...
        <section style={{ textAlign: "center", padding: "80px 0", borderTop: "1px solid var(--color-border)", display: "flex", flexDirection: "column", alignItems: "center", gap: "20px" }}>
          ...
          <p style={{ fontSize: "1rem", color: "var(--color-text-secondary)", maxWidth: "500px", margin: 0 }}>
            Experience gasless, natural-language global payments. Open the developer studio or launch the live remittance client.
          </p>
      ...
      {/* Footer */}
      <footer style={{ borderTop: "1px solid var(--color-border)", background: "rgba(5, 6, 11, 0.9)", padding: "48px 0 24px 0" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "32px", fontSize: "0.875rem" }}>
          
          <div>
            <div className="app-logo" style={{ marginBottom: "16px" }}>
              <div className="app-logo-icon" style={{ background: "var(--color-accent-bg)", color: "var(--color-primary)", width: "24px", height: "24px", borderRadius: "6px", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "12px" }}>W$</div>
              <span className="app-logo-text" style={{ fontSize: "1rem", fontWeight: "bold", marginLeft: "8px" }}>WireStable</span>
            </div>
            <p style={{ color: "var(--color-text-tertiary)", fontSize: "0.75rem", lineHeight: 1.5 }}>
              AI-first stablecoin remittance stack powered by Circle Web3 App Kit and the Arc Chain.
            </p>
          </div>

          <div>
            <strong style={{ color: "var(--color-text-primary)", display: "block", marginBottom: "12px" }}>Product</strong>
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "8px" }}>
              <li><a href="/chat" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Launch Chat App</a></li>
              <li><a href="/agent-studio" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Agent Studio Developer Portal</a></li>
              <li><a href="/admin" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Corporate Dashboard</a></li>
            </ul>
          </div>

          <div>
            <strong style={{ color: "var(--color-text-primary)", display: "block", marginBottom: "12px" }}>Resources</strong>
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "8px" }}>
              <li><a href="/docs" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Documentation</a></li>
              <li><a href="/faq" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>FAQ</a></li>
              <li><a href="/about" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>About Team</a></li>
              <li><a href="/contact" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Support Contact</a></li>
            </ul>
          </div>

          <div>
            <strong style={{ color: "var(--color-text-primary)", display: "block", marginBottom: "12px" }}>Legal</strong>
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "8px" }}>
              <li><a href="/privacy" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Privacy Policy</a></li>
              <li><a href="/terms" style={{ color: "var(--color-text-secondary)", textDecoration: "none" }}>Terms of Service</a></li>
            </ul>
          </div>

        </div>

        <div className="flex flex-col md:flex-row gap-4 justify-between" style={{ maxWidth: "1200px", margin: "40px auto 0 auto", padding: "24px 24px 0 24px", borderTop: "1px solid var(--color-border)", color: "var(--color-text-tertiary)", fontSize: "0.75rem" }}>
          <span>© 2026 WireStable. All rights reserved.</span>
          <span>Powered by Arc Chain & Circle.</span>
        </div>
      </footer>
