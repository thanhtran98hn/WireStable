...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = [
    ...
    "img-src 'self' data: blob: https://*.walletconnect.com https://*.walletconnect.org https://*.rainbow.me https://images.unsplash.com;",
    "font-src 'self' https://fonts.gstatic.com;",
    "connect-src 'self' wss: https://*.walletconnect.com https://*.walletconnect.org https://*.rainbow.me https://*.circle.com https://rpc.testnet.arc.network https://*.arc.network https://api.openai.com;",
    "frame-src 'self' https://*.walletconnect.com https://*.walletconnect.org https://*.rainbow.me;",
    "media-src 'self';",
    "object-src 'none';",
    "base-uri 'self';",
    "form-action 'self';",
